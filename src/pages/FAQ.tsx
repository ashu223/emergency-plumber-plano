  ...
  return <>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, i) => <AccordionItem key={i} value={`item-${i}`} className="bg-card rounded-xl border border-border px-6 shadow-soft">
      ...
      <section className="py-16 lg:py-20 bg-secondary">
        <div className="container text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">Our team is available 24/7 to help. Call anytime to get started.</p>
